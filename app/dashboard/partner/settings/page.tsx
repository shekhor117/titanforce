...
export default function PartnerSettingsPage() {
  ...
  useEffect(() => {
    ...
    const savedSettings = localStorage.getItem(`partnerSettings_${user.id}`)
    if (savedSettings) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem(`partnerSettings_${user?.id}`, JSON.stringify(settingsToSave))
            ...
            <div className="p-8 space-y-4">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm text-foreground/60 ${isBn ? "font-[var(--font-bengali)]" : ""}`}>
                    {isBn ? "গুরুত্বপূর্ণ অংশীদারিত্ব আপডেট পান" : "Get important partnership updates"}
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer pt-4">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm text-foreground/60 ${isBn ? "font-[var(--font-bengali)]" : ""}`}>
                    {isBn ? "সুযোগ এবং ইভেন্ট সম্পর্কে অবহিত থাকুন" : "Stay informed about opportunities and events"}
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer pt-4">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm text-foreground/60 ${isBn ? "font-[var(--font-bengali)]" : ""}`}>
                    {isBn ? "এক্সক্লুসিভ অংশীদার সুবিধা সম্পর্কে জানুন" : "Learn about exclusive partner benefits"}
                  </p>
                </div>
              </label>
            </div>
