      ...
      <main>
        ...
        <section className="hero-gradient relative overflow-hidden py-16 md:py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-4 text-center">
            <Link href="/" className={`inline-flex items-center gap-2 mb-6 px-4 py-2 rounded border-2 border-primary text-primary hover:bg-primary/10 transition-all duration-300 transform hover:scale-105 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"} transition-all duration-700`}>
