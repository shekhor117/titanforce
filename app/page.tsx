...
function LatestNews() {
  const items = [
    { img: "/news-coach.png", title: "Coach Rahman on the upcoming big clash", date: "24 May 2026" },
    { img: "/news-goal.png", title: "Sabbir Hossain scores a brace against Warriors", date: "22 May 2026" },
    { img: "/news-stadium.png", title: "Mulikandi Stadium gets a new look", date: "20 May 2026" },
    { img: "/news-player.png", title: "Player of the Month — Rahim Uddin", date: "18 May 2026" },
  ]
  return (
  ...
  return (
    <div className="panel p-6">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <img src="/team-huddle.png" alt="Team huddle" width={1024} height={768} loading="lazy"
...
function NewsList() {
  const items = [
    { img: "/news-coach.png", t: "Training session ahead of the big match", d: "28 May 2026" },
    { img: "/news-goal.png", t: "Injury Update: Two players ruled out", d: "26 May 2026" },
    { img: "/news-player.png", t: "Youth Academy trials announced", d: "22 May 2026" },
    { img: "/news-stadium.png", t: "Thank you Titans Fans!", d: "18 May 2026" },
  ]
  return (
    <div className="panel p-6">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <div className="panel p-5 sm:p-6 h-full">
              ...
              <div className="grid grid-cols-2 gap-2">
                {["/hero-players.png", "/team-huddle.png", "/news-goal.png", "/news-stadium.png"].map((s, i) => (
