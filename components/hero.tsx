        ...
        <div className="relative max-w-7xl mx-auto h-full min-h-[85vh] sm:min-h-[75vh] lg:min-h-[85vh] z-10">
          ...
          <div className="relative lg:absolute lg:left-0 lg:top-0 lg:w-1/2 lg:h-full w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-20 z-10 flex flex-col justify-center">
            ...
            <div className="animate-smoothFadeUp mb-6">
              <p className={`text-sm uppercase tracking-[0.2em] font-semibold text-primary ${isBn ? "font-[var(--font-bengali)]" : ""}`}>
                MORE THAN A CLUB, WE ARE <span className="text-white">A FORCE</span>
              </p>
            </div>

            {/* Title */}
            <h2 className={`mb-6 text-5xl md:text-6xl lg:text-7xl leading-tight tracking-wider text-white animate-fade-up ${isBn ? "font-[var(--font-bengali)] font-bold" : "font-[var(--font-display)]"}`}>
              <span className="block text-white animate-smoothFadeUp">
                {t.hero.welcome}
              </span>
              <span className="block text-accent mt-3 animate-smoothFadeUp animation-delay-200">
                {t.hero.clubName}
              </span>
            </h2>

            {/* Description */}
            <p className={`mt-6 mb-8 text-base text-white leading-relaxed max-w-lg animate-smoothFadeUp animation-delay-200 ${isBn ? "font-[var(--font-bengali)]" : ""}`}>
              {t.hero.tagline}
            </p>
