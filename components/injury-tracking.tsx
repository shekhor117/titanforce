...
import { useInjuries } from "@/lib/use-data-store"
        ...
        <div className={`space-y-4 transition-all duration-600 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          {loading ? (
            ...
            filteredInjuries.map((injury, index) => {
              ...
              const daysUntil = getDaysUntil(injury.expected_return)
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg text-foreground">{injury.player_name}</h3>
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-3 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="text-foreground font-medium">{injury.injury_type}</div>
                          <div className="text-foreground/60 text-xs">{injury.body_part}</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-foreground font-medium">{formatDate(injury.date_injured)}</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className={`text-sm font-bold ${statusConfig.text}`}>{injury.recovery_percent}%</span>
                      </div>
                      <div className="h-2 bg-secondary/50 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${injury.recovery_percent}%` }}
                        />
                      </div>
